 ...
 * collegata a una tabella reale, un elenco vuoto fara' sparire la striscia
 * da se', senza segnaposto vuoti in pagina.
 *
...
export function TickerRassegna({ voci }: { voci: VoceRassegna[] }) {
  ...
  return (
    <div className="relative z-10 border-t border-white/15 bg-verde-900/70 backdrop-blur-sm">
